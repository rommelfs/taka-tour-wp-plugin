...
<div class="taka-tour-page">
	...
	<section class="taka-section taka-sensei"><p class="taka-kicker"><?php echo esc_html__( 'Sensei', 'taka-tour' ); ?></p><h2><?php echo esc_html__( 'Takafumi Nakayama', 'taka-tour' ); ?></h2><p><?php echo esc_html__( 'Präzision, Ruhe und Bewegungsqualität aus der okinawanischen Tradition.', 'taka-tour' ); ?></p></section>
	...
	<section class="taka-section taka-community"><p class="taka-kicker"><?php echo esc_html__( 'Community', 'taka-tour' ); ?></p><h2><?php echo esc_html__( 'Gemeinsam trainieren', 'taka-tour' ); ?></h2><p><?php echo esc_html__( 'Ein europäisches Treffen für ernsthaftes Training und respektvollen Austausch.', 'taka-tour' ); ?></p></section>
