...
define( 'TAKA_TOUR_VERSION', '0.7.0' );
...
require_once TAKA_TOUR_PLUGIN_DIR . 'includes/class-taka-tour-auto-translator.php';
require_once TAKA_TOUR_PLUGIN_DIR . 'includes/class-taka-tour-data.php';
require_once TAKA_TOUR_PLUGIN_DIR . 'includes/class-taka-tour-translator.php';
